 ...
 * @author MSi-GAMING
 */
public class Sandal extends Kickkers{
...
//        super(Artikel, Warna, Harga, Total_brg);
    ...
    @Override
    void tambahData(){
        System.out.println("Data Berhasil Ditambahkan di Sandal Kickkers !");
    }
    
    @Override
    void ubahData(){
        System.out.println("Data Berhasil Diubah di Sandal Kickkers !");
    }
    
    @Override
    void hapusData(){
        System.out.println("Data Berhasil Dihapus di Sandal Kickkers !");
    }
    
    @Override
    protected void lihatData(){
        System.out.println("Lihat Data Berhasil di Sandal Kickkers !");
    }
